import{_ as s,c as i,o as a,a4 as n}from"./chunks/framework.Daz2Rf8Q.js";const F=JSON.parse('{"title":"Version 1.1.19-alpha","description":"","frontmatter":{},"headers":[],"relativePath":"ADR/1.1.19-alpha.md","filePath":"ADR/1.1.19-alpha.md"}'),l={name:"ADR/1.1.19-alpha.md"},p=n(`<h1 id="version-1-1-19-alpha" tabindex="-1">Version 1.1.19-alpha <a class="header-anchor" href="#version-1-1-19-alpha" aria-label="Permalink to &quot;Version 1.1.19-alpha&quot;">​</a></h1><h2 id="note" tabindex="-1">Note <a class="header-anchor" href="#note" aria-label="Permalink to &quot;Note&quot;">​</a></h2><p>Relocalisation et amélioration du code pour récupérer les données dans le <code>void serialEvent3()</code></p><p>Augmentation du <code>tampon</code> à <code>255</code></p><h2 id="code" tabindex="-1">Code <a class="header-anchor" href="#code" aria-label="Permalink to &quot;Code&quot;">​</a></h2><div class="language-c++ vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">c++</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">#define</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> led</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 2</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div>`,6),h=[p];function k(t,e,E,r,d,g){return a(),i("div",null,h)}const c=s(l,[["render",k]]);export{F as __pageData,c as default};
