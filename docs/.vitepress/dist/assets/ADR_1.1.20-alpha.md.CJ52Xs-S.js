import{_ as s,c as i,o as a,a4 as n}from"./chunks/framework.5uudwu_m.js";const F=JSON.parse('{"title":"Version 1.1.20-alpha","description":"","frontmatter":{},"headers":[],"relativePath":"ADR/1.1.20-alpha.md","filePath":"ADR/1.1.20-alpha.md"}'),l={name:"ADR/1.1.20-alpha.md"},h=n(`<h1 id="version-1-1-20-alpha" tabindex="-1">Version 1.1.20-alpha <a class="header-anchor" href="#version-1-1-20-alpha" aria-label="Permalink to &quot;Version 1.1.20-alpha&quot;">​</a></h1><div class="info custom-block"><p class="custom-block-title">INFO</p><p>Version similaire à la <a href="./ADR/1.1.19-alpha.html">1.1.19-alpha</a></p></div><h2 id="note" tabindex="-1">Note <a class="header-anchor" href="#note" aria-label="Permalink to &quot;Note&quot;">​</a></h2><p>Tentative de détection des début et fin de trame</p><h2 id="code" tabindex="-1">Code <a class="header-anchor" href="#code" aria-label="Permalink to &quot;Code&quot;">​</a></h2><div class="language-c++ vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">c++</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">#define</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> led</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 2</span></span>
