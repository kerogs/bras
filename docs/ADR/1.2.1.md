...
## Note
::: warning
Mise à jours des pins pour le moteur (incompatbile avec les versions >v1.2.1)
:::
...
void configset() {
  ...
  Serial.print(".");
  pinMode(BP1, INPUT); 'Supprimé' // [!code --]
  Serial.print("."); 'Supprimé' // [!code --]
  pinMode(BP2, INPUT); 'Supprimé' // [!code --] 
  Serial.print("."); 'Supprimé' // [!code --]
  pinMode(BPfdc, INPUT);
  Serial.print(".");
