...
void loop() {
  ...
  if (searchArray(tampon, "ks:", 3)) {
    Serial.println("[ks:]");
    if (searchArray(tampon, "open.casier", 11)) {
    ...
    if (searchArray(tampon, "close.casier", 11)) {
    ...
    if (searchArray(tampon, "green.led.casier", 11)) {
