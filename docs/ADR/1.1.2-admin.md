...
## Commande
:::info
toutes les commandes commence par ``ks:``
:::
...
void loop() {
  ...
  if (searchArray(tampon, "ks:", 3)) {
    Serial.println("[ks:]");
    if (searchArray(tampon, "open.casier", 11) || searchArray(tampon, "test.all", 11)) {
    ...
    if (searchArray(tampon, "close.casier", 11) || searchArray(tampon, "test.all", 11)) {
    ...
    if (searchArray(tampon, "print.printer", 11) || searchArray(tampon, "test.all", 11)) {
      Serial.println("[ks:print.printer]");
      imprimante();
      Serial.println("[return:fin]");
    }

    if (searchArray(tampon, "red.ccolor.hmi", 11) || searchArray(tampon, "test.all", 11)) {
    ...
    if (searchArray(tampon, "green.ccolor.hmi", 11) || searchArray(tampon, "test.all", 11)) {
    ...
    if (searchArray(tampon, "white.ccolor.hmi", 11) || searchArray(tampon, "test.all", 11)) {
    ...
    if (searchArray(tampon, "black.ccolor.hmi", 11) || searchArray(tampon, "test.all", 11)) {
    ...
    if (searchArray(tampon, "red.led.casier", 11) || searchArray(tampon, "test.all", 11)) {
    ...
    if (searchArray(tampon, "green.led.casier", 11) || searchArray(tampon, "test.all", 11)) {
