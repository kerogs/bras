...
::: warning
Le Shield n'est pas disponible sur internet. C'est un shield conçu spécialement pour l'arduiono. Il peut être également utilisé en dessous du [shield moteur](/composants/)
:::
...
![Rendu](https://src.ks-infintie.fr/bras/asmi1-19.png)